...
public class OverworldPutConcurrentOreDataMap implements PutConcurrentOreDataMap {
    private final Map<OreType, LongCollection> oreDataMap = new EnumMap<>(OreType.class);
    private final Map<OreType, Object> locks = new EnumMap<>(OreType.class);

    public OverworldPutConcurrentOreDataMap() {
        for(OreType type : OreType.overworldValues()) {
